...
<head>
    ...
    <script src="JS_files/studentlogin-form.js"></script>
</head>

<body style="background-image:url('Images/mowerlogin.jpeg');background-size: cover;">
    <div class="container">
        <div class="container form bg-white pt-5 mt-4 mb-3">
            ...
            <p class="text-center loginHeading hide-me textColor">Student Mower<br>Student Login</p>
        ...
        <!--change it-->
        <p class="text-center loginHeading show-me textColor">Student Mower <br>Student Sign-Up</p>
            ...
            <div class="row show-me">
                <div class="col mt-4 pl-5 pr-5">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-10 pl-0">
                            <input type="text" placeholder="Student / Resident" name="residentType" class='user-type' value="Student">
                        </div>
                    </div>
                    <hr class="hr-1">
